                          ...
                          <table>
                            <tr>
                              <th>
                                ...
                                <p>Queremos informarte que tu beneficio solicitado fue:</p>
                                <table class="spacer">
                                  <tbody>
                                    <tr>
                                      <td height="16px" style="font-size:16px;line-height:16px;">
                                            ...
                                            <th class="small-12 large-6 columns first">
                                              <table>
                                                <tr>
                                                  <th>
                                                    <p>
                                                      <strong>{{ $benefitUser->is_approved === 1 ? 'Aprobado' : 'Rechazado' }}</strong><br>
                                                    </p>
                                                    @if ($benefitUser->is_approved ===  1)
                                                        Podrás hacer uso de él.
                                                    @endif
                                                    @if ($benefitUser->is_approved ===  2)
                                                        Te sugerimos hablar con tu jefe y validar otras posibilidades de redimirlo. Estaremos esperándote nuevamente.
                                                    @endif
                                                    </p>
                                                  </th>
                                                </tr>
                      ...
                      <tr>
                        ...
                        <th class="small-12 large-3 columns">
                          <table>
                            <tr>
                              <th>
                                <p><a href="mailto:juan.soto@flamingo.com.co" style="color: #C8102E;">¿Novedades?
