                ...
                <td>
                  ...
                  <table class="row">
                    <tbody>
                      <tr>
                        <th class="small-12 large-12 columns first last">
                          Puedes aprobar o rechazar esta solicitud en el siguiente <a href="{{ env('APP_URL') }}/assets/angular/benefit-employee/index">enlace</a>, en la pestaña de "Mi Equipo" > "Aprobaciones Pendientes"
                        </th>
                      </tr>
                    </tbody>
                  </table>
